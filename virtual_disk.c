 ...
 * Данный модуль можно использовать либо как каркас блочного утройства под новое ядро, либо для обучающих целей.
 * Можно например создать драйвер блочного устройства для диска с шифрованием данных, тем самым все данные 
 * будут шифроваться "на лету" и хранится на диске в шифрованном виде.) 
*/
